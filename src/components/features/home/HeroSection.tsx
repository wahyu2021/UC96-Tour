...
export function HeroSection() {
  return (
    <section className="relative flex min-h-[85vh] w-full flex-col items-center justify-center overflow-hidden bg-[#0a0a0a]">
      {/* Background Image */}
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 py-24 text-center sm:px-6 lg:px-8">
        ...
        <h1 className="font-heading mt-6 text-4xl font-black uppercase tracking-tighter text-white sm:text-6xl md:text-7xl lg:text-8xl drop-shadow-2xl">
          <span className="block italic leading-none text-neutral-300">Medan Laga</span>
          <span className="mt-2 block bg-gradient-to-br from-[var(--color-primary)] to-orange-500 bg-clip-text text-transparent">
            Unit Combat 96
          </span>
        </h1>
        
        <p className="mx-auto mt-8 max-w-2xl text-lg font-medium text-neutral-300 sm:text-xl">
          Daftarkan tim e-sports terbaik Anda, buktikan kemampuan di arena, dan raih
          posisi puncak dalam turnamen PUBG paling bergengsi tahun ini!
        </p>
        ...
        <div className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          <Link
            href="/tournaments"
            className="flex w-full items-center justify-center gap-3 rounded-md border-2 border-neutral-700 bg-transparent px-8 py-4 text-lg font-bold text-white transition-all hover:border-neutral-500 hover:bg-neutral-800/50 sm:w-auto backdrop-blur-sm"
          >
