...
export function TeamCard({ team }: TeamCardProps) {
  ...
  return (
    <div className="flex flex-col overflow-hidden rounded-xl border border-neutral-200 bg-white transition-all hover:shadow-lg dark:border-neutral-800 dark:bg-[#121212]">
      {/* Bagian Header Card */}
